#!/bin/bash
# Dissekt — Fixed PDF Export (all info, no share)
...
# ============================================
cat > src/lib/generatePDF.ts << 'PDFEOF'
...
echo "✅ PDF generator updated (all information included)"

# ============================================
# Updated AnalysisResult — only Download PDF, no Share
# ============================================
...
echo "✅ AnalysisResult updated (Download PDF only, share removed)"
echo ""
echo "PDF now includes:"
echo "  • Purple branded header with date + model + time"
echo "  • Full analyzed content"
echo "  • Threat score circle with color"
echo "  • ALL techniques with confidence bars, categories, full explanations, evidence quotes"
echo "  • Brief summary + detailed analysis (if available)"
echo "  • ALL fact-checks with publisher, title, rating, and URL"
echo "  • Full spread timeline with platform, title, URL, date"
echo "  • Signal: bias, factuality, sentiment, toxicity"
echo "  • Full toxicity breakdown with bars"
echo "  • Metadata: time, model, cache, heuristic"
echo "  • Blockchain hash + proof status"
echo "  • Footer on every page: dissekt.info + page numbers"
echo ""
