  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      ...
      <div style={{ position: 'relative', background: '#fff', borderRadius: 14, padding: 28, maxWidth: 400, width: '90%', textAlign: 'center', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }}
        ...
        <div style={{ fontSize: 16, fontWeight: 600, color: '#1a1a1a', marginBottom: 6 }}>{feature} needs a free account</div>
        <div style={{ fontSize: 13, color: '#888', lineHeight: 1.6, marginBottom: 20 }}>
          Sign up free to unlock this — 25 brief + 10 detailed scans/day and all components.
        </div>
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
          <a href="/signup" style={{ padding: '8px 20px', background: '#0d9488', color: '#fff', borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>
            Sign up free
          </a>
        ...
        <div style={{ marginTop: 12, fontSize: 11, color: '#aaa' }}>
          Already have an account? <a href="/login" style={{ color: '#0d9488' }}>Sign in</a>
        </div>
      </div>
    </div>
  );
