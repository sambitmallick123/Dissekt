  ...
  return (
    <div style={S.page}>
      <nav style={S.nav}>
        <div style={S.navInner}>
          ...
          <div style={S.navLinks}>
            ...
            <button onClick={onShowFeedback} style={{ color: "#737373", background: "none", border: "none", cursor: "pointer", fontSize: 13 }}>Feedback</button>
      ...
      <div style={S.footer}>
        ...
        <span style={{ margin: '0 8px' }}>·</span><a href="mailto:sambitmallick123@gmail.com" style={{ color: '#7c3aed', textDecoration: 'none' }}>sambitmallick123@gmail.com</a>
