  ...
  return (
    <main style={{ flex: 1, background: '#fafaf8' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '32px 16px' }}>
        ...
        <p style={{ fontSize: 13, color: '#888', marginBottom: 24 }}>Last updated: June 21, 2026 · Beta</p>
        ...
        <div style={{ background: '#fff', border: '1px solid #e5e5e5', borderRadius: 14, padding: '24px 28px', fontSize: 13, color: '#404040', lineHeight: 1.8 }}>
          ...
          <p>Dissekt is an information transparency tool that analyzes content for manipulation techniques, cross-references existing fact-checks, and scores source credibility. It produces a Clarity Score and related analysis across several features: single scans of text, URLs, or images; keyword topic analysis of recent coverage; bulk CSV analysis; side-by-side comparison; a personal knowledge graph (Constellation) with AI-generated cluster reports; topic tracking; a Chrome extension; and a Telegram bot. Dissekt does NOT determine whether content is true or false. It provides analytical perspectives to help you think critically.</p>
          ...
          <p>Free tier provides limited daily scans (3 brief + 1 detailed, resetting at 00:00 GMT) with no account required. A free member account provides expanded limits (25 brief + 10 detailed per day) and access to all features, including Bulk, Compare, and the Observatory. Brief and detailed scans are counted separately; keyword topic analyses count as one scan of the chosen depth. Limits may change as the service evolves.</p>
          ...
          <p>You retain rights to content you submit. By submitting content, you grant us a limited license to process it for analysis. Analysis outputs and scan metadata may be stored to provide features like shareable reports, the knowledge graph, and topic tracking.</p>
