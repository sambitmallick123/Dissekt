        ...
        {!result && !loading && !error && (
          <div>
            <div style={{ textAlign: 'center', padding: '24px 0 20px' }}>
              <div style={{ fontSize: 15, fontWeight: 500, color: '#404040', marginBottom: 4 }}>Paste any article, claim, or URL to inspect</div>
              <div style={{ fontSize: 13, color: '#aaa' }}>Or pick something from Radar below to analyze.</div>
            </div>
