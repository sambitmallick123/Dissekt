...
export default function DashboardPage() {
  ...
  const [tab, setTab] = useState<'overview' | 'apikeys'>('overview');
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '24px 16px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 4 }}>
            <button onClick={() => setTab('overview')} style={{ padding: '5px 14px', borderRadius: 6, fontSize: 11, fontWeight: 600, border: 'none', cursor: 'pointer', background: tab === 'overview' ? '#0d9488' : '#fff', color: tab === 'overview' ? '#fff' : '#555', boxShadow: tab !== 'overview' ? '0 0 0 0.5px #e5eaea' : 'none' }}>📊 Overview</button>
